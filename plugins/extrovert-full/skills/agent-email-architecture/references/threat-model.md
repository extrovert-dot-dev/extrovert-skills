...
| SMTP acceptance mistaken for delivery | A client treats a required-review hold or its original Sent copy as completed delivery. | Check the review thread; SMTP follows review and recipient policies. Preserve Message-ID on retries and keep SMTP unused when read-only access is enough. |
